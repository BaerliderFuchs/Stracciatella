...
import com.baerliderfuchs.stracciatella.objects.blocks.Tap;
...
public class BlockInit {
    ...
    public static final Block tap = null;
    ...
    public static void registerBlocks(final RegistryEvent.Register<Block> event) {
        ...
        event.getRegistry().register(new Tap(Block.Properties.create(Material.WOOD).hardnessAndResistance(0.1f).sound(SoundType.WOOD)).setRegistryName("tap"));
    }
    ...
    public static void registerBlockItems(final RegistryEvent.Register<Item> event) {
        ...
        event.getRegistry().register(new BlockItem(tap, new Item.Properties().group(ItemGroup.DECORATIONS)).setRegistryName("tap"));
    }
}
